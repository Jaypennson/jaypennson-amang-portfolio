...
console.log('%c👋 Hello, Developer!', 'font-size: 20px; font-weight: bold; color: #5eead4;');
console.log('%cInterested in how this site was built? The source code is clean and well-commented!', 'font-size: 14px; color: #94a3b8;');
